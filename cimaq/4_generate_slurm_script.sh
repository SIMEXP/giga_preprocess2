...
echo "Create fmriprep-slurm scripts for cima-q"

DATASET_PATH="/lustre04/scratch/${USER}/CIMAQ"
echo $DATASET_PATH
time=`date +%s`
OUTPUT_PATH="/lustre04/scratch/nclarke/cimaq_fmriprep-${VERSION}lts_${time}"
