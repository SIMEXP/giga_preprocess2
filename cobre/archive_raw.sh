...
#SBATCH --output=/home/nclarke/scratch/logs/cobre_raw_archive.out
#SBATCH --error=/home/nclarke/scratch/logs/cobre_raw_archive.err
#SBATCH --time=21:30:00
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=8G


RAW_PATH="/lustre04/scratch/nclarke/COBRE"
